...
export class SysUserControllerApi {
  ...
  public changeStatusUsingPUT1 = (
    data: ParamsBodychangeStatusUsingPUT1,
    opt?: ExtraFetchParams
  ): AjaxPromise<{ [key: string]: any }> => {
  ...
  public exportUsingPOST = (
    ...
    if ("createTime" in params) p.query.createTime = params.createTime;
    if ("delFlag" in params) p.query.delFlag = params.delFlag;
    if ("dept_ancestors" in params)
      p.query.dept_ancestors = params.dept_ancestors;
    if ("dept_createBy" in params) p.query.dept_createBy = params.dept_createBy;
    if ("dept_createTime" in params)
      p.query.dept_createTime = params.dept_createTime;
    ...
    if ("dept_parentName" in params)
      p.query.dept_parentName = params.dept_parentName;
    ...
    if ("dept_updateTime" in params)
      p.query.dept_updateTime = params.dept_updateTime;
    if ("deptId" in params) p.query.deptId = params.deptId;
    if ("email" in params) p.query.email = params.email;
    ...
    if ("roles_0_createBy" in params)
      p.query.roles_0_createBy = params.roles_0_createBy;
    if ("roles_0_createTime" in params)
      p.query.roles_0_createTime = params.roles_0_createTime;
    if ("roles_0_dataScope" in params)
      p.query.roles_0_dataScope = params.roles_0_dataScope;
    if ("roles_0_delFlag" in params)
      p.query.roles_0_delFlag = params.roles_0_delFlag;
    if ("roles_0_deptCheckStrictly" in params)
      p.query.roles_0_deptCheckStrictly = params.roles_0_deptCheckStrictly;
    if ("roles_0_deptIds" in params)
      p.query.roles_0_deptIds = params.roles_0_deptIds;
    if ("roles_0_flag" in params) p.query.roles_0_flag = params.roles_0_flag;
    if ("roles_0_menuCheckStrictly" in params)
      p.query.roles_0_menuCheckStrictly = params.roles_0_menuCheckStrictly;
    if ("roles_0_menuIds" in params)
      p.query.roles_0_menuIds = params.roles_0_menuIds;
    if ("roles_0_permissions" in params)
      p.query.roles_0_permissions = params.roles_0_permissions;
    if ("roles_0_remark" in params)
      p.query.roles_0_remark = params.roles_0_remark;
    if ("roles_0_roleId" in params)
      p.query.roles_0_roleId = params.roles_0_roleId;
    if ("roles_0_roleKey" in params)
      p.query.roles_0_roleKey = params.roles_0_roleKey;
    if ("roles_0_roleName" in params)
      p.query.roles_0_roleName = params.roles_0_roleName;
    if ("roles_0_roleSort" in params)
      p.query.roles_0_roleSort = params.roles_0_roleSort;
    if ("roles_0_status" in params)
      p.query.roles_0_status = params.roles_0_status;
    if ("roles_0_updateBy" in params)
      p.query.roles_0_updateBy = params.roles_0_updateBy;
    if ("roles_0_updateTime" in params)
      p.query.roles_0_updateTime = params.roles_0_updateTime;
  ...
  public registerUsingPOST = (
    data: ParamsBodyregisterUsingPOST,
    opt?: ExtraFetchParams
  ): AjaxPromise<boolean> => {
  ...
  public resetPwdUsingPUT = (
    data: ParamsBodyresetPwdUsingPUT,
    opt?: ExtraFetchParams
  ): AjaxPromise<{ [key: string]: any }> => {
