...
} from "./components/Password/types";
...
} from "./components/Select/SearchSelect/types";
...
import FieldRangePicker, {
  slots as rangePickerSlots,
...
import FieldTimePicker, {
  slots as timePickerSlots,
...
} from "./components/TimeRangePicker/types";
import FieldTimeRangePicker, {
  slots as timeRangePickerSlots,
          ...
          {defaultRenderText(
            ...
            valueType || "text",
            {
              ...
              renderFormItem: renderFormItem
                ? (...restProps) => {
                    const newDom = renderFormItem?.(...restProps) as
                      | VNode
                      | JSX.Element;
