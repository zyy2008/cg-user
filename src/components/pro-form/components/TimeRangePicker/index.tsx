...
export type ProFormTimeRangePickerProps = Partial<
...
export const ProFormTimeRangePicker = defineComponent({
  ...
  inheritAttrs: false,
  props,
  slots: fieldTimePickerProps as any,
  setup(props, { slots }) {
    const formItemProps = {
      ...props.formItemProps,
...
export default ProFormTimeRangePicker as DefineComponent<ProFormTimeRangePickerProps> &
  Plugin;
